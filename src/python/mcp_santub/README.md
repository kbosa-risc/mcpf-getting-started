...
```sh
poetry run python mcp_frm/pipeline_runtime.py mcp_santub/santub_use_case1.yaml
```
...
```sh
poetry run python mcp_frm/pipeline_runtime.py mcp_santub/santub_use_case2.yaml mcp_santub/santub_use_case1.yaml
```